...
public class WithdrawMoneyAction implements UiAction {

    private final ATMMachine atmMachine;

    public WithdrawMoneyAction(ATMMachine atmMachine) {
    ...
    public void execute() {
        try {
            if (atmMachine.getIsAuthenticated()) {
                ...
                atmMachine.withdrawMoney(atmMachine.getCurrentCreditCard(), amount);
